  ...
  return (
    <div>
      ...
      <section className="relative w-full min-h-screen flex items-center">
        <img
          src="https://res.cloudinary.com/db0wuel0k/image/upload/v1757084651/about__bg_xjhxqq.jpg"
        ...
        <div className="relative z-10 text-white text-left flex ml-10 mb-10">
          <div className="mt-16 pt-10 max-w-3xl">
            ...
            <motion.h1
              ...
              className="transform-gpu will-change-transform text-4xl md:text-7xl font-bold leading-tight"
              style={{ transformStyle: "preserve-3d", backfaceVisibility: "hidden", translateZ: "0" }}
            >
            ...
            <motion.button
              ...
              className="px-8 py-3 bg-[#E50914] hover:bg-[#b20710] text-white rounded-xl font-heading text-lg shadow-md mt-10 hover:cursor-pointer transform-gpu"
      ...
      <section className='relative w-full min-h-screen flex items-center'>
        <div className="flex items-center justify-center gap-20 w-full mx-auto px-20">
          <motion.img
            ...
            src="https://res.cloudinary.com/db0wuel0k/image/upload/v1757086795/portrait-confident-thai-boxers-min_f6zvec.jpg"
            className='hidden md:block h-1/4 w-1/4 rounded-lg ' />

          <div>
            <motion.h3
              initial={{ opacity: 0.5, y: -50, sclae: 0.5 }}
            ...
            <div className='flex flex-col sm:flex-row justify-around items-center mt-12 space-y-6 sm:space-y-0'>
              ...
              <motion.div className='text-center'>
                ...
                <motion.p
                  ...
                  viewport={{ once: false, amount: 0 }}
                  transition={{ duration: 0.6, delay: 2, ease: "easeInOut" }}
                  className='text-sm sm:text-base text-gray-300'>Overall Global Clients</motion.p>
              </motion.div>
              ...
              <motion.div className='text-center'>
                ...
                <motion.p
                  ...
                  viewport={{ once: false, amount: 0 }}
                  transition={{ duration: 0.6, delay: 2, ease: "easeInOut" }}
                  className='text-sm sm:text-base text-gray-300'>Positive Review</motion.p>
              </motion.div>
            </div>
          </div>
        </div>
      ...
      {/* MISSION PART */}
      <section className="bg-black/40 relative text-white w-full flex flex-col items-center justify-center">
        <h2 className="pt-16 text-white text-center text-3xl md:text-4xl font-bold relative z-10 ">
          Mission & values
        </h2>
        <motion.div
          initial={{ opacity: 0, y: 50 }}
          ...
          className="grid grid-cols-1 md:grid-cols-3 mt-24 px-24 gap-16 pb-20 relative w-full">
          <motion.div
            whileHover={{ boxShadow: "0px 0px 15px 5px #E50914" }}
            transition={{ duration: 0.3 }}
            className="relative border-2 border-gray-800 rounded-3xl bg-black/40 p-6 text-center"
          >
            <h3 className="md:text-xl font-semibold mt-4">Science-Backed Coaching</h3>
            <p className="text-gray-300 text-xs md:text-base mt-3">
              We use proven, data-driven methods to create personalized programs that deliver maximum results.
            </p>
          </motion.div>
          <motion.div
            whileHover={{ boxShadow: "0px 0px 15px 5px #E50914" }}
            ...
            className="relative border-2 border-gray-800 rounded-3xl bg-black/40 p-6 text-center"
          >
            <h3 className="md:text-xl font-semibold mt-4">Community First</h3>
            <p className="text-gray-300 text-xs md:text-base mt-3">
              We foster a supportive, inclusive atmosphere where everyone feels welcome and motivated.
            </p>
          </motion.div>
          ...
          <motion.div
            ...
            className="relative border-2 border-gray-800 rounded-3xl bg-black/40 p-6 text-center"
          >
            <h3 className="md:text-xl font-semibold mt-4">Sustainable Results</h3>
            <p className="text-gray-300 text-xs md:text-base mt-3">
              We focus on building healthy, long-term habits for a lifetime of fitness and well-being.
            </p>
          </motion.div>
      ...
      <section className='relative w-full min-h-screen'>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mx-20 mt-10 pb-20">
          {facilities.map((facility, i) => (
            <motion.div
              whileHover={{ scale: 1.1, backdropFilter: "blur(10px)", boxShadow: "0px 0px 10px 10px #E50911B3", y: -10 }}
              key={i}
              className="bg-black/40 border border-gray-700 rounded-xl overflow-hidden hover:translate-y-0.5"
            >
              <img
                src={facility.img}
